/**
 * Platform Navigation Manager - Standalone for Paletteniffer
 * Copy this file to your Paletteniffer project's JS directory
 */

class PlatformNavigationManager {
    constructor() {
        // Platform apps configuration for Paletteniffer
        this.platformApps = [
            {
                name: 'Home',
    ...
    insertNavigation() {
        ...
        const themeToggleBtn = targetElement.querySelector('#themeToggle');
        if (themeToggleBtn) {
